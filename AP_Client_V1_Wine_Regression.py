...
if __name__ == "__main__":
    ...
    ds_reg = ppl.lookup_dataset("wine dataset")
    fs_reg = ppl.lookup_featureset("wine_no_transformations")
    ...
    with mlflow.start_run():
        ...
        model_reg = ppl.lookup_model("elastic_net_wine_model")
