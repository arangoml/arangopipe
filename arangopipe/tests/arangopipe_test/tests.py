...
test_db = client.db(settings.TEST_DB_NAME, username=settings.TEST_USERNAME, password=settings.TEST_PASSWORD)
...
model_perf = {'model_bias': 100, 'run_id': ruuid, "timestamp": str(datetime.datetime.now())}
