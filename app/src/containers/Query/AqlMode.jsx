...
export class AqlHighlightRules extends window.ace.acequire("ace/mode/text_highlight_rules").TextHighlightRules {
	constructor() {
		super();
		var keywords = (
...
export default class AqlMode extends window.ace.acequire('ace/mode/text').Mode {
	constructor() {
		super();
