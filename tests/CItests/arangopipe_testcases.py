...
class TestArangopipe(unittest.TestCase):
    ...
    def setUp(self):
        ...
        conn_params = {
            msc.DB_SERVICE_HOST: self.test_cfg["arangodb"][msc.DB_SERVICE_HOST],
            msc.DB_SERVICE_END_POINT: self.test_cfg["arangodb"][
        ...
        self.config = config
        self.admin = ArangoPipeAdmin(
            reuse_connection=False, config=self.config, persist_conn=False
        )
    ...
    def link_models(self):
        ...
        self.assertTrue(link_added, "Exception raised while linking models")
    ...
    def add_edge_to_arangopipe(self):
        ...
        self.admin.add_edge_definition_to_arangopipe(
            "test_edge_col", "test_edge", "test_vertex_s", "test_vertex_d"
        )
        return
    ...
    def remove_edge_from_arangopipe(self):
        ...
        self.admin.add_edge_definition_to_arangopipe(
            "test_edge_col", "test_edge_1", "test_vertex_s1", "test_vertex_d1"
        )
    ...
    def add_edge_link(self):
        ...
        self.admin.add_edge_definition_to_arangopipe(
            "test_edge_col", "test_edge", "test_vertex_s3", "test_vertex_s4"
        )
    ...
    def test_connection_manager(self):
        msc = ManagedServiceConnParam()
        conn_params = {
            msc.DB_SERVICE_HOST: "arangoml.arangodb.cloud",
